...
public class ExtentReporter {
	...
	//Step1: Add the extent reports dependency in pom.xml file
	...
	sparkReporter.config().setReportName("Tutorials Ninja Framework Extent Report Results");
	sparkReporter.config().setDocumentTitle("TNReportTitle|BootcampReport");
